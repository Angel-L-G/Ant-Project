...
const UsuarioCard = ({user, navigation}: Props) => {
    ...
    return (
        <View style={{ height: 80, padding: 5, margin: 15, flexDirection: 'row'}}>
            ...
            <View style={{width: "20%"}}>
                <TouchableHighlight underlayColor={"rgba(30, 70, 200, 1)"} onPress={() => navigation.navigate("NuevoChat", {name: user.name})} style={{justifyContent: 'center', alignItems: 'center', height: "100%", borderRadius: 20, padding: 10, elevation: 2, backgroundColor: "#2196F3"}}>
